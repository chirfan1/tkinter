...
Label(root, text='To Do List', bg='lightslateblue', font=("Comic Sans MS", 15), wraplength=300).place(
    x=35, y=0)

tasks = Listbox(root, selectbackground='Gold', bg='White', font=('Times New Roman', 12), height=12, width=25)
...
# Creating the Entry widhet where the user can enter a new item
